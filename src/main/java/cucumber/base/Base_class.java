...
public class Base_class {
	...
	public static WebDriver getDriver(String browsername) throws Exception {
		try {
			if (browsername.equalsIgnoreCase("chrome") ) {
				System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+"\\src\\test\\resources\\com\\cucumber\\driver\\chromedriver.exe");
	...
	public static File screenshot(String s) throws Exception {
		TakesScreenshot ts = (TakesScreenshot) driver;
		File screenshotAs = ts.getScreenshotAs(OutputType.FILE);
		File saveFile = new File("C:\\Users\\The Commandant TSP 3\\eclipse-workspace\\AdactinCucumberProject\\src\\test\\resources\\Screen_shot\\failure_SS"+s);
